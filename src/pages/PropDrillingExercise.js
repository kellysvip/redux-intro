...
const RootComponent = (props) => {
  ...
  const removeProductToCart = (removedProduct) => {
  ...
  return (
    <WrapperBox>
      ...
      <Grid container spacing={2} p="1rem">
        <Grid item md={6}>
          <ProductPage products={products} addProduct={addProductToCart} removeProduct={removeProductToCart}/>
        </Grid>
        <Grid item md={6}>
          <CartPage cart={cart} />
        </Grid>
...
const ProductPage = (props) => {
  return (
    <WrapperBox>
      ...
      <Grid container spacing={2} p="1rem">
        <Grid item sm={6}>
          <ProductOne product={props.products[0]} addProduct={props.addProduct} removeProduct={props.removeProduct}/>
        </Grid>
        <Grid item sm={6}>
          <ProductTwo product={props.products[1]} addProduct={props.addProduct} removeProduct={props.removeProduct}/>
        </Grid>
      </Grid>
    </WrapperBox>
  );
